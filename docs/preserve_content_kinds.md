...
# Slot: preserve_content_kinds 


_Content kinds (viewpoint-supplied CURIEs) whose content must be preserved. Core assigns no meaning to these CURIEs._
...
URI: [grits:preserve_content_kinds](https://w3id.org/grits/preserve_content_kinds)
...
| ---  | ---  |
| self | grits:preserve_content_kinds |
| native | grits:preserve_content_kinds |
