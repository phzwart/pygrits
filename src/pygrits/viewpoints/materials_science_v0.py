...
linkml_meta = LinkMLMeta({'default_prefix': 'mse',
     ...
     'id': 'https://w3id.org/grits/viewpoints/materials_science_v0',
     ...
     'prefixes': {'de': {'prefix_prefix': 'de',
                  ...
                  'mse': {'prefix_prefix': 'mse',
                          'prefix_reference': 'https://w3id.org/grits/viewpoints/materials_science_v0/'}},
...
class ReasoningPolicy(OperationalLayer):
    ...
    notes: Optional[str] = Field(default=None, description="""Free-text clarification of the reasoning posture.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Scope',
                       'ReasoningPolicy',
                       'ThermodynamicScope',
                       'MaterialsScienceScope']} })
    layer_name: str = Field(default=..., description="""Human-readable name (e.g. extraction_profile:detailed:v0). Combined with content hash, this gives identity-by-declaration.""", json_schema_extra = { "linkml_meta": {'domain_of': ['OperationalLayer']} })
...
class ThermodynamicScope(Scope):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/grits/viewpoints/materials_science_v0'})
