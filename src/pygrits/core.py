...
class Object(Grit):
    ...
    instance_of: Optional[list[str]] = Field(default=None, description="""Ontology class(es) this grit instantiates, expressed as CURIEs into any ontology referenced by the active VocabularyPack. Used for subsumption reasoning, merge operations, and SPARQL traversal. No core-supplied permissible values — the ontology supplies the class hierarchy. Examples: CHMO:0000823 (Raman spectroscopy), OBI:0000070 (assay), schema:Person. Optional in v1; absence means class membership is not formally declared.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object', 'EvidenceRecord'], 'in_subset': ['ExtendedProfile']} })
    ...
    payload_schema: Optional[ContentReference] = Field(default=None, description="""Optional content-addressed reference to the schema governing normalized_payload (on EvidenceRecord) or features (on Object). When present, the payload is treated as typed CURIE-keyed triples and validated against the referenced schema. When absent, the payload is an unschematized JSON string (v1 default). The schema must be reachable via the ContentReference uri and its sha256 must match.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object', 'EvidenceRecord'], 'in_subset': ['ExtendedProfile']} })
...
class EvidenceRecord(Grit):
    ...
    instance_of: Optional[list[str]] = Field(default=None, description="""Ontology class(es) this grit instantiates, expressed as CURIEs into any ontology referenced by the active VocabularyPack. Used for subsumption reasoning, merge operations, and SPARQL traversal. No core-supplied permissible values — the ontology supplies the class hierarchy. Examples: CHMO:0000823 (Raman spectroscopy), OBI:0000070 (assay), schema:Person. Optional in v1; absence means class membership is not formally declared.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object', 'EvidenceRecord']} })
    payload_schema: Optional[ContentReference] = Field(default=None, description="""Optional content-addressed reference to the schema governing normalized_payload (on EvidenceRecord) or features (on Object). When present, the payload is treated as typed CURIE-keyed triples and validated against the referenced schema. When absent, the payload is an unschematized JSON string (v1 default). The schema must be reachable via the ContentReference uri and its sha256 must match.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object', 'EvidenceRecord']} })
    id: str = Field(default=..., description="""Canonical grit identifier.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Grit'], 'in_subset': ['MVE']} })
    type: str = Field(default=..., description="""For Object and EvidenceRecord, a CURIE into a viewpoint vocabulary. For Activity, a CURIE corresponding to the ActivityType value (e.g. grits:activity_type/synthesis_edge).""", json_schema_extra = { "linkml_meta": {'domain_of': ['Grit'], 'in_subset': ['MVE']} })
    viewpoint_directive_id: str = Field(default=..., description="""Reference to the ViewpointDirective that shaped this grit. The bootstrap meta-viewpoint and the blank-slate viewpoint are valid references; absence is not.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Confidence', 'CompatibilityJudgment', 'Grit'],
...
class ViewpointDirective(Composable, Object):
    ...
    abstraction_level: Optional[str] = Field(default=None, description="""The ontology class at which this viewpoint makes claims. Instance-level viewpoints reference leaf classes (e.g. the class for a specific assay type); merged/general viewpoints reference parent classes (e.g. the class for any Raman spectroscopy). When present, grits extracted under this viewpoint automatically inherit a should_not_claim rule: claims are valid only at the declared class level and must not assert instance-specific details suppressed by the abstraction. Optional in v1.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ViewpointDirective']} })
    composition_mode: Optional[CompositionMode] = Field(default=CompositionMode.additive, description="""How this layer folds against its declared parents during resolution. Defaults to additive.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Composable'], 'ifabsent': 'string(additive)'} })
    source_artifact_refs: Optional[list[ContentReference]] = Field(default=None, description="""ContentReferences to the source artifacts this Object derives from.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object'], 'in_subset': ['MVE']} })
    evidence_record_ids: Optional[list[str]] = Field(default=None, description="""References to EvidenceRecord grits anchoring this Object's claims.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object'], 'in_subset': ['MVE']} })
    instance_of: Optional[list[str]] = Field(default=None, description="""Ontology class(es) this grit instantiates, expressed as CURIEs into any ontology referenced by the active VocabularyPack. Used for subsumption reasoning, merge operations, and SPARQL traversal. No core-supplied permissible values — the ontology supplies the class hierarchy. Examples: CHMO:0000823 (Raman spectroscopy), OBI:0000070 (assay), schema:Person. Optional in v1; absence means class membership is not formally declared.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Object', 'EvidenceRecord'], 'in_subset': ['ExtendedProfile']} })
